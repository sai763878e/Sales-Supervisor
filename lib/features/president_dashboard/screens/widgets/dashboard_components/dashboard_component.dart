...
import 'package:sales_supervisor/features/president_dashboard/screens/widgets/charts/growth_degrowth_charts.dart';
...
class DashboardComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (componentModel.value.isFullScreen) {
      // componentModel.value.isFullScreen=false;
      controller.parseSSPLSSPDashboard(componentModel);
    }

    // if(componentModel.value.doSmoothScroll){
    //   presidentMyDashboardController.scrollToTarget(componentModel, CHelperFunction.screenWidth() * 0.85);
    // }
    ...
    Widget getChartWidget() {
      if (controller.aiAnalysisEnabled.value) {
        ...
        if (getPieChartModels().contains(componentModel.value.type)) {
        ...
        } else if (getSingleBarChartModels()
        ...
        } else if (getGrowthDeGrowthChartModels()
            .contains(componentModel.value.type)) {
          return GrowthDegrowthCharts(
            chartData: controller.dashboardChartModelMap[
                        controller.selectedView.value] !=
                    null
                ? controller
        ...
        } else if (getTableDashboard().contains(componentModel.value.type)) {
          return DashboardTableCharts(
            data: controller.dashboardChartModelMap[
                ...
                : [],
            headers: controller.dashboardChartModelMap[
                        controller.selectedView.value] !=
                    null
                ? controller
                    .dashboardChartModelMap[controller.selectedView.value]!
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    (controller.selectedSubViewList
                                                .isNotEmpty &&
                                            controller.selectedSubViewList
                                                    .length >
                                                1)
                                    ...
                                    PopupMenuButton(
                                      ...
                                      itemBuilder: (context) => [
                                        if (!componentModel.value.isFullScreen)
                                          PopupMenuItem(
                                            child: ListTile(
                                              leading:
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // TextButton(onPressed: controller.showFullScreen(context,isDark), child: Text("Full Screen")),
